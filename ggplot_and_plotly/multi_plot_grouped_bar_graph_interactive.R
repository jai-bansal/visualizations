...
# PLOT DATA.
  ...
  plot_1 = ggplotly(ggplot(data = census_subset[Name != 'United States'], 
                  aes(x = variable, 
                      y = value)) +
  ...
  plot_2 = ggplotly(ggplot(data = census_subset[Name == 'United States'], 
                  aes(x = variable, 
                      y = value)) +
            geom_bar(aes(fill = Name), 
                     position = 'dodge', 
            ...
            theme(axis.text.x =  element_text(color = 'black', 
                  ...
                  scale_x_discrete(labels = c('1960s', '1970s', '1980s', '1990s', '2000s')) +
                  guides(fill = guide_legend(title = '')) +
            ggtitle('% Growth by Decade for Selected States and US') +
            xlab('Decade') +
            ylab('% Growth'))
