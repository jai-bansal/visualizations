# This script creates a violin plot using 'census_data.csv'.
...
violin_plot_data = [census_data['1960'], census_data['1970'], census_data['1980'],
...
# Add violin plot.
ax1.violinplot(violin_plot_data,
               showmeans = True,
               showmedians = True)

# Add title and axis title.
plt.title('Violin Plots of US State Populations by Year')
plt.xlabel('Year')
