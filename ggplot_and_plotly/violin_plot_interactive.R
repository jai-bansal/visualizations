# This script creates a violin plot using 'census_data.csv' using the 'ggplot2' and 'plotly' libraries.
...
# This section transforms the data for plotting.
  ...
  # Rename columns in 'melted_data'.
  melted_data = rename(melted_data, 
                       Year = variable, 
                       Population = value)
